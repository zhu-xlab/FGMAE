...
class LMDBDataset(Dataset):
    ...
    def __init__(self, lmdb_file, is_slurm_job=False, transform=None, normalize=False, bands='B2'):
    ...
    def __getitem__(self, index):
        ...
        _, _, sample_s1_bytes, sample_s1_shape, target_bytes = pickle.loads(data)
        ...
        sample_s1 = np.concatenate(img_bands,axis=2) # VV,VH (w,h,c)
