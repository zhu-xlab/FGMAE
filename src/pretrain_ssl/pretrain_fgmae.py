...
#import models.mae.models_mae_3_1 as models_mae
import models.mae.models_mae_2 as models_mae_2
import models.mae.models_mae as models_mae

from models.mae.engine_pretrain import train_one_epoch

#from datasets.SSL4EO.ssl4eo_dataset_rgb import SSL4EORGB,random_subset
...
def get_args_parser():
    ...
    # Dataset parameters
    parser.add_argument('--root_dir', default='/datasets01/imagenet_full_size/061417/', type=str,
                        help='dataset path')
    parser.add_argument('--in_channels', default=3, type=int,
                        help='input number of bands')                                                
    ...
    parser.add_argument('--feature', type=str, default='raw', choices=['raw','hog','canny','densesift','ndi','hog+ndi'])
    parser.add_argument('--hog_norm', action='store_true', default=False)    
...
def main(args):
    ...
    dataset_train = random_subset(dataset_train,frac=args.frac,seed=42)
    ...
    # define the model
    if args.feature=='hog+ndi':
        model = models_mae_2.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, in_chans=args.in_channels,feature=args.feature,hog_norm=args.hog_norm)
    else:
        model = models_mae.__dict__[args.model](norm_pix_loss=args.norm_pix_loss, in_chans=args.in_channels,feature=args.feature,hog_norm=args.hog_norm)
